...
<div class="page-content">
	...
	<div class="color-container">
		<div class="color-wrapper">
			...
			<div class="tblack-btn color-btn color-selected" id="black"></div>
		</div>

		<div class="color-wrapper">
			<div class="color-text">WHITE</div>
			<div class="twhite-btn color-btn" id="white"></div>
		</div>	
	</div>
	...
	<div class="design-wrapper">
		<div id="b-tshirts-container" class="tshirts-wrapper">
			<ul class="tshirts-container">
				<li id="click1-container">							
					
					<img data-img-id="click1" class="black-tshirts tshirt-selection" id="tshirt-design-1-black" src="images/thumbs/tshirts/new/click1-black.jpg">
					<div class="hover-layer"></div>
				</li>

				<li id="click2-container">
							
					
					<img data-img-id="click2" class="black-tshirts tshirt-selection" id="tshirt-design-2-black" src="images/thumbs/tshirts/new/click2-black.jpg">
					<div class="hover-layer"></div>	
					
				</li>

				<li id="click3-container">			
								
					
					<img data-img-id="sxsw1" class="black-tshirts tshirt-selection" id="tshirt-design-3-black" src="images/thumbs/tshirts/new/sxsw1-black.jpg">
					<div class="hover-layer"></div>
		...
		<!-- WHITE TSHIRTS -->
		<div id="w-tshirts-container" class="tshirts-wrapper">
			<ul  class="tshirts-container">
				<li>							
					<img data-img-id="click1" class="white-tshirts tshirt-selection" id="tshirt-design-1-white" src="images/thumbs/tshirts/new/click1-white.jpg" style="opacity: 0">
				...
				<li>
					...
					<img data-img-id="click2" class="white-tshirts tshirt-selection" id="tshirt-design-2-white" src="images/thumbs/tshirts/new/click2-white.jpg" style="opacity: 0">
				...
				<li>			
					...
					<img data-img-id="sxsw1" class="white-tshirts tshirt-selection" id="tshirt-design-3-shite" src="images/thumbs/tshirts/new/sxsw1-white.jpg" style="opacity: 0">
				...
				<li>			
					...
					<img data-img-id="sxsw2" class="white-tshirts tshirt-selection" id="tshirt-design-4-white" src="images/thumbs/tshirts/new/sxsw2-white.jpg" style="opacity: 0">
